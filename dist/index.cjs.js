...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "205", height: "26", href: isDark ? "/images/fly/LogoTextNewDark.png" : "/images/fly/LogoTextNewWhite.png" })));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#6E491E", textDisabled: "#BDC2C4", textSubtle: "#FF4D88", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
