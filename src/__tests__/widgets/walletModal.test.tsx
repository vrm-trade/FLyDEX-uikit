    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          >
            <h2
              class="sc-bdfBwQ sc-hKgILt jOXdxc ESJmc"
              color="text"
            >
              Connect to a wallet
            </h2>
          ...
          <button
            ...
            class="sc-jSgupP iVCfEu sc-gKsewC kpTpvg"
            type="button"
          >
            <svg
              class="sc-dlfnbm blscwP"
              color="primary"
              viewBox="0 0 24 24"
              width="20px"
        ...
        >
          <button
            class="sc-jSgupP VxXdj"
            id="wallet-connect-metamask"
            style="justify-content: space-between;"
            type="button"
          >
            <div
              class="sc-bdfBwQ jSjNpb"
              color="primary"
            >
              Metamask
            </div>
            <svg
              class="sc-dlfnbm cvWwXR"
              color="text"
              viewBox="0 0 96 96"
              width="32px"
              xmlns="http://www.w3.org/2000/svg"
    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          >
            <a
              class="sc-bdfBwQ sc-gsTCUz bkPitJ djpNeP"
              color="primary"
            ...
            <div
              class="sc-bdfBwQ sc-crrsfI bzUZVG cBWJzl"
              color="text"
              role="button"
            >
              Copy Address
